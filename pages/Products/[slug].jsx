	...
	return (
		<section class="text-gray-600  body-font overflow-hidden mb-10">
				...
				<div class="lg:w-4/5 mx-auto flex flex-wrap">
					...
					<div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
						...
						<div class="flex">
							...
							<button class="flex ml-auto buto border-0 py-2 px-6 focus:outline-none  rounded">
								Buy now
							</button>
						...
						<div class="flex mx-auto mt-5 items-center">
			...
			<div className="flex justify-center">
				<button class=" mx-auto buto border-0 py-2 px-6 focus:outline-none  rounded">
					Add to cart
				</button>
			</div>
		</section>
