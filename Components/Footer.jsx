		...
		<footer class="text-white hedu body-font">
				...
				<div class="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
					<div class="lg:w-1/4 md:w-1/2 w-full px-4">
						...
						<nav class="list-none mb-10">
							<li>
								<a class=" hover:text-black">First Link</a>
							</li>
							<li>
								<a class=" hover:text-black">Second Link</a>
							</li>
							<li>
								<a class=" hover:text-black">Third Link</a>
							</li>
							<li>
								<a class=" hover:text-black">Fourth Link</a>
							</li>
						</nav>
					</div>
					<div class="lg:w-1/4 md:w-1/2 w-full px-4">
			...
			<div class="">
				<div class="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
					<p class="text- text-sm text-center sm:text-left">
						© 2020 Tailblocks —
						<a
							href="https://twitter.com/knyttneve"
							rel="noopener noreferrer"
							class=" ml-1"
	ext-blatext-black="_blank">
							@knyttneve
						</a>
					</p>
